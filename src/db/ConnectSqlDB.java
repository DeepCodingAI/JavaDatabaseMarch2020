...
public class ConnectSqlDB {
    ...
    public static Properties loadProperties() throws IOException{
        ...
        InputStream ism = new FileInputStream("/Users/mrahman/develop/deepcoding/project10/secret.properties");
        prop.load(ism);
        ism.close();
        return prop;
    }
    ...
    public void insertDataFromStringToSqlTable(String ArrayData, String tableName, String columnName1,
                                               String columnName2)
    {
        try {
            connectToSqlDatabase();
                                               ...
                                               String columnName3)
    {
        try {
            ...
            ps = connect.prepareStatement("INSERT INTO "+tableName+" ( " + columnName1 + "," + columnName2 + ","+
                    columnName3+") VALUES(?,?,?)");
            ps.setString(1,"Jwuel Ahmed");
            ps.setInt(2,5091);
            ps.setString(3,"09-10-1995");
            ps.executeUpdate();
    ...
    public static void main(String[] args)throws IOException, SQLException, ClassNotFoundException {
        ...
        insertProfileToSqlTable("Students","stName", "stID", "stDOB");
